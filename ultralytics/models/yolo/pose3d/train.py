...
class Pose3dTrainer(yolo.detect.DetectionTrainer):
    ...
    Attributes:
        ...
        model (Pose3dModel): The pose estimation model being trained.
    ...
    Examples:
        >>> from ultralytics.models.yolo.pose import Pose3dTrainer
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides: Optional[Dict[str, Any]] = None, _callbacks=None):
        """
        Initialize a Pose3dTrainer object for training YOLO pose estimation models.
    ...
    def get_model(
        ...
        Returns:
            (Pose3dModel): Initialized pose estimation model.
        """
        model = Pose3dModel(
